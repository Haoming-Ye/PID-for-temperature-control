...
def pidloop(Kp,Ki,Kd,setpoint,time):
...
ulist_ki=[]
ind_ki=0
for Ki in np.arange(0.03,0.04,0.01):
...
def checkup(Kp,Ki,Kd,sp,t):
    a,b,c,d=pidloop(Kp,Ki,Kd,sp,t)
    plotting(d,a,b,c,sp,Kp,Ki,Kd)
    compplot(d,a,b,c,sp,Kp,Ki,Kd)

# Results check
# 8,0.03,0
checkup(8,0.03,0,40,2200)
#checkup(8,0.03,0,[40,30,70],6400)
#checkup(8,0.03,0,25)
